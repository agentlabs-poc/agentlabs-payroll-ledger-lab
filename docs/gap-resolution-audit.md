# Gap discussion and resolution audit
...
The accurate status is: **the reviewed core rules are agreed; no named proposal
awaits an answer; explicit policy/specification deferrals and code gaps remain.**
